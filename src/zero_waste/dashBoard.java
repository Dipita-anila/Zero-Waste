...
//        add(l);
        ...
        JLabel heading = new JLabel("Welcome to Donor Home Page");
       ...
       // panel2 = new JPanel();
        ...
        cb1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                dispose();
                new donation_information(username,userid).setVisible(true);
            }
        });
...
//        panel2.add(Donate);
        ...
        cb5.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                dispose();
                new orgDonationForm(username,userid).setVisible(true);
            }
        });
