...
public class remainingFoodInfo extends JFrame {
    ...
    private JTextField textfld2, textfld3;;
    ...
    remainingFoodInfo(final String username) {
        ...
        this.setBounds(720, 300, 435, 413);
        ...
        textfld2.setBorder(new LineBorder(Color.BLACK,2));
        ...
        textfld3.setBorder(new LineBorder(Color.BLACK,2));
        ...
        button1.setBounds(100, 310, 90, 30);
        button1.setFont(fn);
        panel2.add(button1);
        ...
        button2.setBounds(230, 310, 90, 30);
        button2.setFont(fn);
        panel2.add(button2);
    ...
    public static void main(String[] args) {
        ...
        frame.setBounds(720, 300, 435, 413);
